    ...
    return (
        <Container fixed>
            ...
            <Grid container spacing={2}>
                        ...
                        <React.Fragment key={index}>
                            <Grid item xs={12} md={4}>
                                <Card>
                                    ...
                                    <CardActions>
                                        <Button variant='contained' size="small" sx={{ fontWeight: 700, marginBottom: 2 }} onClick={() => handleClick(element)}>ADD TO CART</Button>
                                    </CardActions>
                                </Card>
                            </Grid>
                        </React.Fragment>
                ...
                <CartModal open={open} setOpen={setOpen} cart={cart} activeid={activeid} />
            </Grid>
        </Container>
    );
}